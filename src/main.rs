...
impl Accipere {
    pub fn new() -> Self {
        ...
        let (cpu, gpu, net, ram, os) = (
            cpu_handle.join().expect("Thread to initilize CPU module failed"),
            gpu_handle.join().expect("Thread to initilize GPU module failed"),
            net_handle.join().expect("Thread to initilize NET module failed"),
            ram_handle.join().expect("Thread to initilize RAM module failed"),
            os_handle.join().expect("Thread to initilize OS module failed"),
        );

        Accipere { cpu, gpu, net, ram, os }
    }
